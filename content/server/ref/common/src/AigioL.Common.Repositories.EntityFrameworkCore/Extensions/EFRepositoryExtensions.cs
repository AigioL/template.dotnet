...
namespace AigioL.Common.Repositories.EntityFrameworkCore.Extensions;
...
public static partial class EFRepositoryExtensions
{
    ...
    public static string GetSqlSetIdentityInsert(this IEFRepository repository, bool enable)
    {
        ...
        return SqlStringHelper.IDENTITY_INSERT(tableName, enable);
    }
    ...
    /// <returns></returns>
    public static int IdentityInsertRange<[DynamicallyAccessedMembers(IEntity.DAMT)] TEntity>(this IEFRepository<TEntity> repository,
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static async Task<int> IdentityInsertRangeAsync<[DynamicallyAccessedMembers(IEntity.DAMT)] TEntity>(this IEFRepository<TEntity> repository,
    ...
    /// <param name="disable"></param>
    /// <returns></returns>
    public static async Task<int> SetDisableByIdAsync<[DynamicallyAccessedMembers(IEntity.DAMT)] TEntity, [DynamicallyAccessedMembers(IEntity.DAMT)] TPrimaryKey>(this IQueryable<TEntity> query, TPrimaryKey id, bool disable)
