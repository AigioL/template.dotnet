...
// https://github.com/dotnet/reactive/blob/main/Rx.NET/Source/src/System.Reactive/Disposables/CompositeDisposable.cs
...
public sealed class CompositeDisposable : ICollection<IDisposable>/*, ICancelable*/
{
    ...
    const int MaximumLinearSearchThreshold = 1024;
    ...
    public IEnumerator<IDisposable> GetEnumerator()
    {
        lock (_gate)
        {
            ...
            return new CompositeEnumerator(current is List<IDisposable?> currentList ? [.. currentList] : [.. ((Dictionary<IDisposable, int>)current).Keys]);
        }
    }
...
file static class Strings_Core
{
    /// <summary>
    /// https://github.com/dotnet/reactive/blob/main/Rx.NET/Source/src/System.Reactive/Strings_Core.resx#L126
    /// </summary>
    internal const string DISPOSABLES_CANT_CONTAIN_NULL = "Disposables collection can not contain null values.";
}