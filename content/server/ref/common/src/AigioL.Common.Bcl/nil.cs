...
global using never = System.Nullable<System.nil>; // like typescript
...
/// </summary>
public readonly partial struct nil : IConvertible
{
    /// <summary>
    /// typeof(nil).FullName
    /// </summary>
    ...
    public static implicit operator DateTimeOffset(nil _) => default;

    public static implicit operator DateOnly(nil _) => default;
    ...
    public static bool IsNilType(Type t)
    {
        if (t == typeof(nil) || t == typeof(nil?))
        {
            return true;
        }
        return false;
...
partial struct nil : global::System.Text.Json.Serialization.IJsonSerializerContext
{
    static global::System.Text.Json.Serialization.JsonSerializerContext global::System.Text.Json.Serialization.IJsonSerializerContext.GetDefault()
